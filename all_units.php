...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#ajaxdata").load("all_units_all.php");
    ...
    $("#school").change(function(){
      ...
      $("#ajaxdata").load("all_units_filtered.php?school=" + school + "&dept=" + dept + "&course=" + course);
    });
    ...
    $("#download").click(function(){
      ...
      var school = encodeURIComponent($("#school").val()); // Encode the selected value from the first dropdown
      var dept = encodeURIComponent($("#dept").val()); // Encode the selected value from the second dropdown
      var url = "all_units_pdf.php?school=" + school + "&dept=" + dept + "&course=" + course;
...
?>
 ...
 <h2><B> UNIT DETAILS </B></h2>

 <a href="admin_new_unit.php" class="btn-download">

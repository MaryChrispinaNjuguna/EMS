...
class PDF_MC_Table extends FPDF {
    ...
    $this->Ln(3);
    $this->Cell(0, 7, 'LECTURERS', 0,1,'C');
    $this->Ln(2);
    $this->SetFont('Arial', 'B', 11);

    $this->SetFillColor(193,193,193);
    $this->SetDrawColor(50,54,57);
    $this->Cell(25,10,'PF No',1,0,'',true);
    $this->Cell(40,10,'Name',1,0,'',true);
    $this->Cell(50,10,'Email',1,0,'',true);
    $this->Cell(50,10,'School',1,0,'',true);
    $this->Cell(30,10,'Department',1,1,'',true);
